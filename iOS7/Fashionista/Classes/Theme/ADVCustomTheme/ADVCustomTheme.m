...
- (UIColor *)secondColor {
    return [UIColor colorWithRed:0.45f green:0.45f blue:0.45f alpha:1.00f];
}
...
{
    return [UIColor colorWithRed:0.89f green:0.24f blue:0.19f alpha:1.00f];
}
...
- (UIFont *)navigationFont { 
    return [UIFont fontWithName:@"OpenSans" size:22.0f];
}
...
- (UIFont *)segmentFont {
    return [UIFont fontWithName:@"Avenir-Heavy" size:14.0f];
}
